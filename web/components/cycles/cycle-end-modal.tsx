...
import { CycleStartForm } from "./cycle-start-form";
// types
...
import { CycleEndForm } from "./cycle-end-form";
...
export const CycleEndModal: React.FC<CycleModalProps> = (props) => {
...
const handleFormSubmit = async (formData: Partial<ICycle>, dirtyFields: any) => {
    ...
    if (payload.start_date && payload.end_date) {
        // Assuming dateChecker function is removed, directly set isDateValid to true
